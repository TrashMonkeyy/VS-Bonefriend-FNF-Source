...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'wasteland':
				dialogue = CoolUtil.coolTextFile(Paths.txt('wasteland/bonefriendDialogue'));
			case 'heatwave':
				dialogue = CoolUtil.coolTextFile(Paths.txt('heatwave/bonefriendDialogue'));
			case 'resurgence':
				dialogue = CoolUtil.coolTextFile(Paths.txt('resurgence/bonefriendDialogue'));
		}
		...
		switch(stageCheck)
		{
			...
			case 'bonefriendstage':
			{
				defaultCamZoom = 0.9;
						curStage = 'bonefriendstage';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bonefriendstage/bonefriend_bg'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			}
			case 'bonefriendstage2':
			{
				defaultCamZoom = 0.9;
						curStage = 'bonefriendstage2';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bonefriendstage2/bonefriend_bg2'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
			}
			case 'bonefriendstage3':
			{
				defaultCamZoom = 0.9;
						curStage = 'bonefriendstage3';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bonefriendstage3/bonefriend_bg3'));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
		...
		switch (curStage)
		{
			...
			case 'schoolEvil':
				...
				gf.y += 300;
			case 'bonefriendstage':
				boyfriend.setPosition(870, 483.95);
				gf.setPosition(367.95, 161.95);
			case 'bonefriendstage2':
				boyfriend.setPosition(870, 483.95);
				gf.setPosition(367.95, 161.95);
			case 'bonefriendstage3':
