...
HXLINE(  40)		::haxe::Log_obj::trace(HX_("this is dance double",92,8c,5e,ab),::hx::SourceInfo(HX_("source_bonefriend/smTools/SMFile.hx",d1,85,03,38),40,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
HXLINE(  42)		inc = (inc + 4);
HXLINE(  43)		::haxe::Log_obj::trace(data->__get(inc),::hx::SourceInfo(HX_("source_bonefriend/smTools/SMFile.hx",d1,85,03,38),43,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
...
HXLINE(  58)		::haxe::Log_obj::trace((this->measures->length + HX_(" Measures",95,d3,b0,47)),::hx::SourceInfo(HX_("source_bonefriend/smTools/SMFile.hx",d1,85,03,38),58,HX_("smTools.SMFile",e3,d5,c7,d6),HX_("new",60,d0,53,00)));
            	}
