...
HXLINE(  56)		this->animation->addByPrefix(HX_("bonefriend",a2,a8,9c,c0),HX_("bonefriend story",f7,6d,a1,d3),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("bonefriend",a2,a8,9c,c0), ::CharacterSetting_obj::__alloc( HX_CTX ,-90,-10,null(),null()));
HXDLIN(  24)			return _g;
            		}
