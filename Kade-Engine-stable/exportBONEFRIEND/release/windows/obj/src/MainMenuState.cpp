...
HXLINE(  32)		this->optionShit = ::Array_obj< ::String >::fromData( _hx_array_data_205e8859_1,3);
...
HXLINE( 249)			::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source_bonefriend/MainMenuState.hx",ae,fa,b8,a6),249,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
...
HXLINE( 245)			::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source_bonefriend/MainMenuState.hx",ae,fa,b8,a6),245,HX_("MainMenuState",59,88,5e,20),HX_("goToState",4e,a5,e1,c9)));
